...
function HeroSection() {
  ...
  return (
    // ── Landmark region with descriptive label ──
    <section
      aria-labelledby="hero-heading"
      className="relative w-full min-h-screen overflow-hidden bg-[#020408]"
    >

      {/* ── Canvas: hidden from assistive tech (decorative) ── */}
      <canvas
        ref={canvasRef}
        aria-hidden="true"
      ...
      {/* ── Hero image — meaningful alt removed, purely decorative ── */}
      <img
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-8">
        ...
        {/* Badge — decorative, not needed by screen readers */}
        <div
          aria-hidden="true"
        ...
        {/* ── Heading — id matches aria-labelledby on section ── */}
        <h1
          id="hero-heading"
        ...
        {/* ── Subtext — sufficient contrast: gray-300 on dark bg passes AA ── */}
        <p className="text-gray-300 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
          Interactive simulations and real-world scenarios that train your team
          to recognize threats and make smarter security decisions.
        </p>

        {/* ── CTAs — focus-visible ring, descriptive labels ── */}
        ...
        >
          {[
            { value: 'AI', label: 'Powered Simulations' },
