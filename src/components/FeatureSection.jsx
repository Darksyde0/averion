...
function FeatureSection() {
  ...
  return (
    <section
      ...
      className="bg-[#020408] py-28 px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        {/* Features grid */}
        <ul
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden list-none"
