...
function Footer() {
  ...
  return (
    <footer
      ...
      className="bg-[#020408] border-t border-white/5 px-8 py-16">
              ...
              <ul className="flex items-center gap-3 mt-6 list-none">
                {socialLinks.map((social) => (
                  <li key={social.label}>
                      ...
                      className="w-8 h-8 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-gray-400 hover:text-white transition-colors duration-200
