    ...
    <footer className="bg-[#020408] border-t border-white/5 px-8 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              Cybersecurity awareness training that transforms your team from your biggest vulnerability into your strongest defense.
            </p>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-xs">© 2026 Averion. All rights reserved.</p>
