      ...
      <div
        ...
        <blockquote className="relative z-10 bg-white/5 border border-white/10 rounded-2xl p-5">
          ...
          <footer className="flex items-center gap-2">
            ...
            <cite className="text-gray-500 text-xs not-italic">Averion Security Team</cite>
          </footer>
        </blockquote>
      </div>
      ...
      <main
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">{t('login.subtext')}</p>
          </div>
          ...
          <form
            ...
            <div>
              ...
              <div className="relative">
                ...
                {/* Screen reader hint about toggle */}
