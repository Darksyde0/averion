  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'averiontech47@gmail.com',
      href: 'mailto:averiontech47@gmail.com',
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      href: 'https://maps.google.com/?q=Aveiro,Portugal',
    },
  ]

  const socials = [
    {
      label: 'Follow Averion on Facebook',
      href: 'https://facebook.com',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      label: 'Follow Averion on X (formerly Twitter)',
      href: 'https://x.com',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      label: 'Follow Averion on Instagram',
    ...
    <div className="flex flex-col min-h-screen bg-[#020408]">
      ...
      <section
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <h1
            id="contact-heading"
            className="text-white text-5xl md:text-6xl font-bold leading-tight mb-5"
            ...
            <span className="sr-only">{t('contact.subtext')}</span>
          </h1>
        </div>
      </section>

      {/* ── Main content ── */}
      <main id="main-content" className="flex-1 px-8 pb-24">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <aside
            ...
            {/* Social links */}
            <div className="bg-[#04080f] border border-white/5 rounded-2xl p-6">
              <h2 className="text-white text-sm font-semibold mb-4">Follow Us</h2>
            ...
            <div
              ...
              className="bg-gradient-to-br from-red-600/10 to-red-900/10 border border-red-500/20 rounded-2xl p-6">
